...
/**Funcion responsable de abrir le archivo iframe.
 * Display resource iframe.
 * @param object $resource
 * @param object $cm
 * @param object $course
 * @param stored_file $file main file
 * @return does not return
 */
function resource_display_iframe($resource, $cm, $course, $file) {
	global $PAGE, $OUTPUT, $CFG;
...
<html dir="$dir">
  <head>
    ...
    <iframe name="Stack" src="$fileurl" 
    	frameborder="0" style="overflow: 
    		; hidden; height: 100%; width: 100%; position: absolute;" height="100%" width="100%" />
